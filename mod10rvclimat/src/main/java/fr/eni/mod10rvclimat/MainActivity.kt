...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val alClim = arrayListOf<Climatisation>(
        ...
        rvClim.adapter = ClimatisationAdapter(alClim, ClimatisationAdapter.OnClimClickListener {
            Toast.makeText(this, "Vous avez appuyé sur la clim ${it.marque}", Toast.LENGTH_SHORT).show()
        })
    }
}